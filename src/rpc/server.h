...
/**
 * Tokugawa RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern UniValue setztokseed(const UniValue& params, bool fHelp);
extern UniValue getztokseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdztok(const UniValue& params, bool fHelp);
extern UniValue dztokstate(const UniValue& params, bool fHelp);
