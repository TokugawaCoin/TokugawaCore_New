...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Tokugawa features */
        {"tokugawa", "masternode", &masternode, true, true, false},
        {"tokugawa", "listmasternodes", &listmasternodes, true, true, false},
        {"tokugawa", "getmasternodecount", &getmasternodecount, true, true, false},
        {"tokugawa", "masternodeconnect", &masternodeconnect, true, true, false},
        {"tokugawa", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"tokugawa", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"tokugawa", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"tokugawa", "masternodecurrent", &masternodecurrent, true, true, false},
        {"tokugawa", "masternodedebug", &masternodedebug, true, true, false},
        {"tokugawa", "startmasternode", &startmasternode, true, true, false},
        {"tokugawa", "createmasternodekey", &createmasternodekey, true, true, false},
        {"tokugawa", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"tokugawa", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"tokugawa", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"tokugawa", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"tokugawa", "getmasternodescores", &getmasternodescores, true, true, false},
        {"tokugawa", "mnbudget", &mnbudget, true, true, false},
        {"tokugawa", "preparebudget", &preparebudget, true, true, false},
        {"tokugawa", "submitbudget", &submitbudget, true, true, false},
        {"tokugawa", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"tokugawa", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"tokugawa", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"tokugawa", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"tokugawa", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"tokugawa", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"tokugawa", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"tokugawa", "checkbudgets", &checkbudgets, true, true, false},
        {"tokugawa", "mnsync", &mnsync, true, true, false},
        {"tokugawa", "spork", &spork, true, true, false},
        {"tokugawa", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getztokseed", &getztokseed, false, false, true},
        {"zerocoin", "setztokseed", &setztokseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdztok", &searchdztok, false, false, true},
        {"zerocoin", "dztokstate", &dztokstate, false, false, true}
...
{
    return "> tokugawa-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:7118/\n";
}
