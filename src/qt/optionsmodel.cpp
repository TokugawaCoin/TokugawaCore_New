...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::TOK);
...
// Wallet
    ...
    if (settings.contains("nAnonymizeTokugawaAmount"))
        SoftSetArg("-anonymizetokugawaamount", settings.value("nAnonymizeTokugawaAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in tokugawa.cpp during shotdown to also remove the window positions
