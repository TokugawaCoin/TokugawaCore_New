...
/* Tokugawa GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Tokugawa"
#define QAPP_ORG_DOMAIN "tokugawa.org"
#define QAPP_APP_NAME_DEFAULT "Tokugawa-Qt"
#define QAPP_APP_NAME_TESTNET "Tokugawa-Qt-testnet"
