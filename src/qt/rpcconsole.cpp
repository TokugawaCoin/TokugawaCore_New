                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzTOKPathCustom = GetArg("-ztokbackuppath", "");
    ...
    if(!strzTOKPathCustom.empty()) {
        ui->wallet_customztokbackuppath->setText(QString::fromStdString(strzTOKPathCustom));
        ui->wallet_customztokbackuppath_label->setVisible(true);
        ui->wallet_customztokbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzTOKPathCustom.empty()) && nCustomBackupThreshold > 0) {
