...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Tokugawa Core tokugawa-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  tokugawa-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded tokugawa transaction") + "\n" +
                               "  tokugawa-tx [options] -create [commands]   " + _("Create hex-encoded tokugawa transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded tokugawa transaction
