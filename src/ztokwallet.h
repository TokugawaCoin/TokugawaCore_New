...
#ifndef Tokugawa_ZTOKWALLET_H
#define Tokugawa_ZTOKWALLET_H
...
public:
    CzTOKWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZTOK(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZTOK(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);

private:
    uint512 GetZerocoinSeed(uint32_t n);
};

#endif //Tokugawa_ZTOKWALLET_H
