...
In order to support loading of multiple wallets in tokugawa-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is tokugawa.cpp.
...
Changes to tokugawa.cpp
----------------------
tokugawa.cpp is the entry point into tokugawa-qt, and as such, will require some minor modifications to provide hooks for
