...
#   c) node1 mines 32 blocks, so now node 0 has 60001tok, node 1 has 4250tok, node2 has none.
#   d) node0 sends 601 tok to node2, in two transactions (301 tok, then 300 tok).
