...
RESOURCES += src/qt/tokugawa.qrc src/qt/tokugawa_locale.qrc

TRANSLATIONS += src/qt/locale/tokugawa_bg.ts \
                src/qt/locale/tokugawa_de.ts \
                src/qt/locale/tokugawa_en.ts \
                src/qt/locale/tokugawa_es.ts \
                src/qt/locale/tokugawa_fi.ts \
                src/qt/locale/tokugawa_fr.ts \
                src/qt/locale/tokugawa_it.ts \
                src/qt/locale/tokugawa_ja.ts \
                src/qt/locale/tokugawa_pl.ts \
                src/qt/locale/tokugawa_pt.ts \
                src/qt/locale/tokugawa_ru.ts \
                src/qt/locale/tokugawa_sk.ts \
                src/qt/locale/tokugawa_sv.ts \
                src/qt/locale/tokugawa_vi.ts \
                src/qt/locale/tokugawa_zh_CN.ts \
                src/qt/locale/tokugawa_zh_TW.ts
