Contributing to Tokugawa Core
============================

The Tokugawa Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Tokugawa Core project, and is not to be
confused with overall Tokugawa Network Protocol consensus changes.

Whether a pull request is merged into Tokugawa Core rests with the project merge
...
Patches that change Tokugawa consensus rules are considerably more involved than
...
Where a patch set proposes to change the Tokugawa consensus, it must have been
...
The project leader is the release manager for each Tokugawa Core release.
